...
<?php	
	...
	{
		echo "<tr><td>" . $row['Quote_ID'] . "</td><td>" . $row['Date_of_Quote'] . "</td><td>" . $row['Company_Name'] . "</td><td>" . $row['Commission'] 
			. "</td><td>" . $row['Sanctioned'] . "</td><td>" . $row['Ordered'] . "</td><td>" . $row['Process_Date']	. "</td></tr>";
	}
	echo "</table>";
?>
</body>
